...
class EmailTest extends BootstrapComponentsTestCase
{
    ...
    {
        $html = bsEmail()->name('name')->hidePlaceholder()->toHtml();
    ...
    {
        $html = bsEmail()->name('name')->toHtml();
        $this->assertContains('for="email-name"', $html);
    ...
    {
        $messageBag = app(MessageBag::class)->add('other_name', null);
        $html = bsEmail()->name('name')->showSuccessFeedback()->render(['errors' => $messageBag]);
        $this->assertContains('<div class="valid-feedback d-block">', $html);
    }
    ...
    {
        $messageBag = app(MessageBag::class)->add('other_name', null);
        $html = bsEmail()->name('name')->hideSuccessFeedback()->render(['errors' => $messageBag]);
        $this->assertNotContains('<div class="valid-feedback d-block">', $html);
    }
}
