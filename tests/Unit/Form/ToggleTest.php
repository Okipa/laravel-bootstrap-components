...
class ToggleTest extends BootstrapComponentsTestCase
{
    ...
    public function testConfigComponentClass()
    {
        ...
        $html = toggle()->name('name')->toHtml();
        $this->assertContains('class="toggle-name-component switch custom-control-input ' . $configComponentCLass . '"', $html);
    }
    ...
    public function testSetComponentClass()
    {
        ...
        $this->assertContains('class="toggle-name-component switch custom-control-input ' . $customComponentCLass . '"', $html);
