...
class NumberTest extends BootstrapComponentsTestCase
{
    ...
    {
        $html = bsNumber()->name('name')->hidePlaceholder()->toHtml();
    ...
    {
        $messageBag = app(MessageBag::class)->add('other_name', null);
        $html = bsNumber()->name('name')->showSuccessFeedback()->render(['errors' => $messageBag]);
        $this->assertContains('<div class="valid-feedback d-block">', $html);
    }
    ...
    {
        $messageBag = app(MessageBag::class)->add('other_name', null);
        $html = bsNumber()->name('name')->hideSuccessFeedback()->render(['errors' => $messageBag]);
        $this->assertNotContains('<div class="valid-feedback d-block">', $html);
    }
}
