...
class ButtonCreateTest extends BootstrapComponentsTestCase
{
    use RoutesFaker;
    ...
    {
        // components
        $this->assertTrue(array_key_exists('button_create', config('bootstrap-components')));
        // components.button_create
        $this->assertTrue(array_key_exists('view', config('bootstrap-components.button_create')));
        $this->assertTrue(array_key_exists('icon', config('bootstrap-components.button_create')));
        $this->assertTrue(array_key_exists('label', config('bootstrap-components.button_create')));
        $this->assertTrue(array_key_exists('class', config('bootstrap-components.button_create')));
        $this->assertTrue(array_key_exists('html_attributes', config('bootstrap-components.button_create')));
        // components.button_create.class
        $this->assertTrue(array_key_exists('container', config('bootstrap-components.button_create.class')));
        $this->assertTrue(array_key_exists('component', config('bootstrap-components.button_create.class')));
        // components.button_create.html_attributes
        $this->assertTrue(array_key_exists('container', config('bootstrap-components.button_create.html_attributes')));
        $this->assertTrue(array_key_exists('component', config('bootstrap-components.button_create.html_attributes')));
    }
    ...
    {
        $html = buttonCreate()->type('submit')->toHtml();
        $this->assertContains('<div class="submit-container', $html);
        $this->assertNotContains('<a href="http://localhost"', $html);
        $this->assertContains('class="submit-component', $html);
    }
    ...
    public function testConfigIcon()
    {
        ...
        config()->set('bootstrap-components.button_create.icon', $configIcon);
        $html = buttonCreate()->toHtml();
    ...
    {
        config()->set('bootstrap-components.button_create.icon', null);
        $html = buttonCreate()->toHtml();
    ...
    public function testConfigLabel()
    {
        ...
        config()->set('bootstrap-components.button_create.label', $configLabel);
        $html = buttonCreate()->toHtml();
    ...
    {
        config()->set('bootstrap-components.button_create.label', null);
        $html = buttonCreate()->toHtml();
    ...
    public function testConfigContainerClass()
    {
        ...
        config()->set('bootstrap-components.button_create.class.container', [$configContainerCLass]);
        $html = buttonCreate()->toHtml();
    ...
    public function testConfigComponentClass()
    {
        ...
        config()->set('bootstrap-components.button_create.class.component', [$configComponentCLass]);
        $html = buttonCreate()->toHtml();
    ...
    public function testSetComponentClass()
    {
        ...
        config()->set('bootstrap-components.button_create.class.component', [$customComponentCLass]);
    ...
    public function testConfigContainerHtmlAttributes()
    {
        ...
        config()->set('bootstrap-components.button_create.html_attributes.container', [$configContainerAttributes]);
        $html = buttonCreate()->toHtml();
    ...
    public function testConfigComponentHtmlAttributes()
    {
        ...
        config()->set('bootstrap-components.button_create.html_attributes.component', [$configComponentAttributes]);
        $html = buttonCreate()->toHtml();
