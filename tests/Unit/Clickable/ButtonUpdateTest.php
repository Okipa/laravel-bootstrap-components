...
class ButtonUpdateTest extends BootstrapComponentsTestCase
{
    use RoutesFaker;
    ...
    {
        // components
        $this->assertTrue(array_key_exists('button_update', config('bootstrap-components')));
        // components.button_update
        $this->assertTrue(array_key_exists('view', config('bootstrap-components.button_update')));
        $this->assertTrue(array_key_exists('icon', config('bootstrap-components.button_update')));
        $this->assertTrue(array_key_exists('label', config('bootstrap-components.button_update')));
        $this->assertTrue(array_key_exists('class', config('bootstrap-components.button_update')));
        $this->assertTrue(array_key_exists('html_attributes', config('bootstrap-components.button_update')));
        // components.button_update.class
        $this->assertTrue(array_key_exists('container', config('bootstrap-components.button_update.class')));
        $this->assertTrue(array_key_exists('component', config('bootstrap-components.button_update.class')));
        // components.button_update.html_attributes
        $this->assertTrue(array_key_exists('container', config('bootstrap-components.button_update.html_attributes')));
        $this->assertTrue(array_key_exists('component', config('bootstrap-components.button_update.html_attributes')));
    }
    ...
    {
        $html = buttonUpdate()->type('submit')->toHtml();
        $this->assertContains('<div class="submit-container', $html);
        $this->assertNotContains('<a href="http://localhost"', $html);
        $this->assertContains('class="submit-component', $html);
    }
    ...
    public function testConfigIcon()
    {
        ...
        config()->set('bootstrap-components.button_update.icon', $configIcon);
        $html = buttonUpdate()->toHtml();
    ...
    {
        config()->set('bootstrap-components.button_update.icon', null);
        $html = buttonUpdate()->toHtml();
    ...
    public function testConfigLabel()
    {
        ...
        config()->set('bootstrap-components.button_update.label', $configLabel);
        $html = buttonUpdate()->toHtml();
    ...
    {
        config()->set('bootstrap-components.button_update.label', null);
        $html = buttonUpdate()->toHtml();
    ...
    public function testConfigContainerClass()
    {
        ...
        config()->set('bootstrap-components.button_update.class.container', [$configContainerCLass]);
        $html = buttonUpdate()->toHtml();
    ...
    public function testConfigComponentClass()
    {
        ...
        config()->set('bootstrap-components.button_update.class.component', [$configComponentCLass]);
        $html = buttonUpdate()->toHtml();
    ...
    public function testSetComponentClass()
    {
        ...
        config()->set('bootstrap-components.button_update.class.component', [$customComponentCLass]);
    ...
    public function testConfigContainerHtmlAttributes()
    {
        ...
        config()->set('bootstrap-components.button_update.html_attributes.container', [$configContainerAttributes]);
        $html = buttonUpdate()->toHtml();
    ...
    public function testConfigComponentHtmlAttributes()
    {
        ...
        config()->set('bootstrap-components.button_update.html_attributes.component', [$configComponentAttributes]);
        $html = buttonUpdate()->toHtml();
