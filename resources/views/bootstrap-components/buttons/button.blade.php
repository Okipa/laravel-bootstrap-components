<div{{ htmlAttributes($containerId ? ['id' => $containerId] : null) }}{{ classTag($type . '-container', $containerClasses) }}{{ htmlAttributes($containerHtmlAttributes) }}>
    {{ htmlAttributes($type === 'button' ? '<a' : '<button') }}{{ htmlAttributes($componentId ? ['id' => $componentId] : null) }}{{ htmlAttributes($type === 'button' ? 'href="' . $url . '"' : 'type="' . $type . '"') }}{{ classTag($type . '-component', $componentClasses) }}{{ htmlAttributes($componentHtmlAttributes) }}{{ htmlAttributes($label ? 'title="' . __($label) .'"' : null) }}>
