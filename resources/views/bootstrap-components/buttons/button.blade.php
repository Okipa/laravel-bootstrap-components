<div{{ htmlAttributes($containerId ? ['id' => $containerId] : null) }}{{ classTag('component-container', $containerClasses) }}{{ htmlAttributes($containerHtmlAttributes) }}>
    {{ htmlAttributes($type === 'button' ? '<a' : '<button') }}{{ htmlAttributes($componentId ? ['id' => $componentId] : null) }}{{ htmlAttributes($type === 'button' ? 'href="' . $url . '"' : 'type="' . $type . '"') }}{{ classTag('component', $type === 'submit' ? 'form-control' : null, 'btn', $componentClasses) }}{{ htmlAttributes($label ? 'title="' . $label .'"' : null) }}{{ htmlAttributes($componentHtmlAttributes) }}>
